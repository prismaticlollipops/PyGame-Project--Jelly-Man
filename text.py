...
class TextGroup(object):
    ...
    def addText(self, text, colour, x, y, size, time=None, id=None):
        self.nextid += 1
        self.alltext[self.nextid] = Text(text, colour, x, y, size, time=time, id=id)
        return self.nextid
    ...
    def setupText(self):
        ...
        self.alltext[READYTXT] = Text("PRESS SPACEBAR TO START!", BLACK, 2*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
        self.alltext[PAUSETXT] = Text("PAUSED!", BLACK, 10.625*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
        self.alltext[GAMEOVERTXT] = Text("GAMEOVER!", WHITE, 10*TILEWIDTH, 20*TILEHEIGHT, size, visible=False)
